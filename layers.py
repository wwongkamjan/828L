...
class SquareLoss:
    ...
    def forward(self):
        ...
        self.out_array = (1/2*(self.num_data ))*np.abs(self.in_array - self.labels)**2
        return self.out_array
    def backward(self):
